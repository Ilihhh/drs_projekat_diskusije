...
class UserSchema(Schema):
    ...
    address = fields.Str()  # Polje za adresu
    ...
    # New field for tracking first login
    is_first_login = fields.Bool(dump_only=True)  # Only for serialization, not updatable via API
